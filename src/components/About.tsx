...
export default function About() {
  const missionPoints = [
    'Menanamkan nilai-nilai keimanan dan ketaqwaan dalam setiap aspek pembelajaran',
    'Menciptakan lingkungan pembelajaran yang efektif, kreatif, dan menyenangkan',
    'Mengembangkan pendidikan karakter yang kuat untuk membentuk pribadi yang tangguh',
    'Mengintegrasikan teknologi dalam proses pembelajaran untuk persiapan masa depan'
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            yang menggabungkan akademik, karakter, dan spiritualitas.
          </p>
        </div>
            ...
            <div className="bg-orange-50 p-6 rounded-xl border border-orange-100">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 font-medium">Sri Hendrawati, S.Pd</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Terwujudnya sekolah berkualitas dalam mencetak generasi berkarakter, dilandasi iman dan taqwa,
                    beradaptasi dengan teknologi, dan menerapkan dimensi profil kelulusan.
                  </p>
                </div>
              </div>
            </div>
