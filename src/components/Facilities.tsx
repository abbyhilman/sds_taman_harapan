import { AirVent, Monitor, BookOpen, Dumbbell, Projector, Heart } from 'lucide-react';
  ...
  const facilities = [
    {
      ...
      description: 'Kelas nyaman dengan pendingin udara untuk mendukung konsentrasi belajar siswa',
    ...
    },
    {
      icon: Monitor,
      title: 'Lab Komputer',
      description: 'Laboratorium komputer modern untuk pembelajaran teknologi dan digital',
    ...
    },
    {
      ...
      description: 'Setiap kelas dilengkapi proyektor untuk pembelajaran interaktif dan multimedia',
    ...
    },
    {
      icon: BookOpen,
      title: 'Perpustakaan',
      description: 'Perpustakaan dengan koleksi buku lengkap untuk menumbuhkan minat baca',
    ...
    },
    {
      ...
      description: 'Fasilitas kesehatan dengan peralatan medis untuk keamanan dan kesehatan siswa',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            yang optimal dan kenyamanan seluruh siswa.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-t ${facility.color} opacity-60 group-hover:opacity-50 transition-opacity`}></div>
        ...
        <div className="mt-16 bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 lg:p-12">
          <div className="text-center max-w-3xl mx-auto">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
              Lingkungan Belajar yang Nyaman dan Aman
            </h3>
            <p className="text-gray-700 leading-relaxed mb-6">
              Semua fasilitas kami dirancang dan dirawat dengan baik untuk menciptakan lingkungan belajar
              yang kondusif, aman, dan menyenangkan bagi seluruh siswa.
            </p>
